...
description: 'Last updated: December 26, 2024'
sidebarTitle: 'Terms'
---
...
- __Application__ means the software program provided by the Company downloaded by You on any electronic device, named Cerevox
...
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Cerevox, Inc., 536 Middlebury Dr. Sunnyvale, CA 94087.
...
- __Website__ refers to Cerevox, accessible from [https://cerevox.ai](https://cerevox.ai)
